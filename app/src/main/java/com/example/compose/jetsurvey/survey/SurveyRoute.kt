        ...
        AnimatedContent(
            ...
            when (targetState.surveyQuestion) {
                ...
                SurveyQuestion.FREE_NEXT_TIME -> {
                    NextFreeTimeQuestion(
                        selectedAnswers = viewModel.nextFreeTimeResponse,
                        onOptionSelected = viewModel::onNextFreeTimeResponse,
                        modifier = modifier,
                    )
                }

                SurveyQuestion.FREE_NEXT2_TIME -> {
                    Next2FreeTimeQuestion(
                        selectedAnswers = viewModel.nextFreeTimeResponse,
                        onOptionSelected = viewModel::onNextFreeTimeResponse,
                        modifier = modifier,
                    )
