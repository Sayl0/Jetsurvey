...
val md_theme_light_primary = Color(0xFFD12105)
val md_theme_light_onPrimary = Color(0xFFFFFFFF)
val md_theme_light_primaryContainer = Color(0xFFFDDFDB)
val md_theme_light_onPrimaryContainer = Color(0xFF550C00)
val md_theme_light_secondary = Color(0xFF705E5C)
val md_theme_light_onSecondary = Color(0xFFFFFFFF)
val md_theme_light_secondaryContainer = Color(0xFFEBDDF7)
val md_theme_light_onSecondaryContainer = Color(0xFF2C1C19)
...
val md_theme_light_inversePrimary = Color(0xFFFFC3B9)
val md_theme_light_shadow = Color(0xFF000000)
val md_theme_light_surfaceTint = Color(0xFFF32706)

val md_theme_dark_primary = Color(0xFFFFC3B9)
val md_theme_dark_onPrimary = Color(0xFFAF4635)
val md_theme_dark_primaryContainer = Color(0xFFF96851)
...
val md_theme_dark_inversePrimary = Color(0xFFF12707)
val md_theme_dark_shadow = Color(0xFF000000)
val md_theme_dark_surfaceTint = Color(0xFFFFC3B9)

val seed = Color(0xFFF02201)
