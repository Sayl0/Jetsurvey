...
@Composable
fun NextFreeTimeQuestion(
    selectedAnswers: List<Int>,
    onOptionSelected: (selected: Boolean, answer: Int) -> Unit,
    modifier: Modifier = Modifier,
) {
    MultipleChoiceQuestion(
        titleResourceId = R.string.in_my_free_time2,
        directionsResourceId = R.string.select_all,
        possibleAnswers = listOf(
            R.string.read2,
            R.string.work_out2,
            R.string.draw2,
            R.string.play_games2,
            R.string.dance2,
            R.string.watch_movies2,
        ),
        selectedAnswers = selectedAnswers,
        onOptionSelected = onOptionSelected,
        modifier = modifier,
...
@Composable
fun Next2FreeTimeQuestion(
    selectedAnswers: List<Int>,
    onOptionSelected: (selected: Boolean, answer: Int) -> Unit,
    modifier: Modifier = Modifier,
) {
    MultipleChoiceQuestion(
        titleResourceId = R.string.in_my_free_time3,
        directionsResourceId = R.string.select_all,
        possibleAnswers = listOf(
            R.string.read3,
            R.string.work_out3,
            R.string.draw3,
            R.string.play_games3,
            R.string.dance3,
            R.string.watch_movies3,
        ),
        selectedAnswers = selectedAnswers,
        onOptionSelected = onOptionSelected,
        modifier = modifier,
...
@Composable
fun Next3FreeTimeQuestion(
    selectedAnswers: List<Int>,
    onOptionSelected: (selected: Boolean, answer: Int) -> Unit,
    modifier: Modifier = Modifier,
) {
    MultipleChoiceQuestion(
        titleResourceId = R.string.in_my_free_time4,
        directionsResourceId = R.string.select_all,
        possibleAnswers = listOf(
            R.string.read4,
            R.string.work_out4,
            R.string.draw4,
            R.string.play_games4,
            R.string.dance4,
            R.string.watch_movies4,
        ),
        selectedAnswers = selectedAnswers,
        onOptionSelected = onOptionSelected,
        modifier = modifier,
...
@Composable
fun Next4FreeTimeQuestion(
    selectedAnswers: List<Int>,
    onOptionSelected: (selected: Boolean, answer: Int) -> Unit,
    modifier: Modifier = Modifier,
) {
    MultipleChoiceQuestion(
        titleResourceId = R.string.in_my_free_time5,
        directionsResourceId = R.string.select_all,
        possibleAnswers = listOf(
            R.string.read5,
            R.string.work_out5,
            R.string.draw5,
            R.string.play_games5,
            R.string.dance5,
            R.string.watch_movies5,
        ),
        selectedAnswers = selectedAnswers,
        onOptionSelected = onOptionSelected,
        modifier = modifier,
